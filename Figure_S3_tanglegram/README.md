# ABOUT Supplementary Figure 3 - comparison of *cyc2* vs riboprotein-based phylogeny in *Chlorobia*
...
No code this time. I opened both trees in Dendroscope `v3.5.9` and made a tanglegram according to their instructions. I then saved the tanglegram as a SVG (`Figure_S3_raw.svg`), which I subsequently touched up in Inkscape to produce `Figure_S3_cleaned.pdf`, the final version of the figure:

![Figure_S3](plot/Figure_S3_cleaned.png)
