# Figure_2B_plotter.R
# Generates panel B of Supplementary Figure 2 for the Chlorobia cyc2 paper
...
main <- function(params) {
  ...
  # Filter
  alignment <- dplyr::filter(alignment, position %in% SUBSET_BASES)
  alignment_summ <- dplyr::filter(alignment_summ, position %in% SUBSET_BASES)
