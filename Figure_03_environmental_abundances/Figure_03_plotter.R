...
library(here)
# setwd("/home/jmtsuji//Research_General/PhD/04b_Metagenome_resequencing_F2015/10_ATLAS_re_analysis/15_final_zenodo_code/Chlorobia_cyc2_code/Figure_03_environmental_abundances")
source(here::here("Figure_03_libraries.R"))
...
params$gtdb_filename <- "plotting_files/gtdbtk.summary.tsv"
params$mapping_stats_filename <- "plotting_files/bin_read_mapping_summary.tsv"
params$dataset_info_read_mapping_filename <- "plotting_files//dataset_info_read_mapping_vs1.tsv"
params$assembled_read_stats_filename <- "plotting_files/assembled_read_stats_vs2.tsv"
params$drep_summary_filename <- "plotting_files/checkm_stats_reduced_mod.tsv"
params$clarify_unresolved_taxa <- FALSE

# MetAnnotate - bins
params$metannotate_bin_filename <- "plotting_files/metannotate_dRep_bins.tsv"
params$hmm_info_bins_filename <- "plotting_files/hmm_info_bins_vs6.tsv"
params$dataset_info_bins_filename <- "plotting_files/dataset_info_bins_vs1.tsv"
params$evalue_cutoff_bins <- 1e-40
params$rank_to_summarize <- "family"
params$taxon_to_keep <- "Chlorobia"
params$taxon_keep_rank <- "class"

params$output_filepath <- "Figure_03_raw.pdf"
#####
