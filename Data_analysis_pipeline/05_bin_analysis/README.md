...
The output file `all_annotations`[random_code]`.tsv` shows the hits of the HMMs on all datsets, along with the e-value score. This is used in the code for Supplementary Figure 3 and is available for download on Zenodo -- see the Supplementary Figure 3 folder.  
